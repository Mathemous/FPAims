  ...
  return (
    <details className="database-updater">
      ...
      <div className="updater-body">
        ...
        <p>Automatic item updates are paused. Changed narratives must first be converted into individual items, with recipients and source references, then reviewed before publishing. The importer blocks updates that would replace item lists with narratives.</p>
